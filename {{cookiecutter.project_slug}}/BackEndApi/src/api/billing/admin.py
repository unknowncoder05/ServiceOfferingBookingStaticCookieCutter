...
class BillingSettingsAdmin(admin.ModelAdmin):
    ...
    The changelist immediately redirects to the single settings row.
    """
    ...
    def changelist_view(self, request, extra_context=None):
        ...
        return HttpResponseRedirect(
            reverse('admin:billing_billingsettings_change', args=[obj.pk])
        )
...
class CreditBalanceAdmin(admin.ModelAdmin):
    ...
    def grant_link(self, obj):
        url = reverse('admin:billing_creditbalance_grant', args=[obj.pk])
    ...
    def get_urls(self):
        ...
        custom_urls = [
            path(
                ...
                name='billing_creditbalance_grant',
            ),
        ]
    ...
    def grant_credits_view(self, request, pk):
        ...
        if balance_obj is None:
            return HttpResponseRedirect(reverse('admin:billing_creditbalance_changelist'))
        ...
        if request.method == 'POST':
            ...
            try:
                ...
                return HttpResponseRedirect(
                    reverse('admin:billing_creditbalance_changelist')
                )
